...
find . -path "*luci*/admin/system.lua" 2>/dev/null
sed -i 's/os.date("%c")/os.date("%Y-%m-%d %H:%M:%S")/g' package/feeds/luci/luci/modules/admin-full/luasrc/controller/admin/system.lua
