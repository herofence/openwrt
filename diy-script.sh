...
git clone --depth=1 --single-branch https://github.com/linkease/istore.git package/istore
git clone --depth=1 --single-branch https://github.com/linkease/nas-packages.git package/nas-packages
git clone --depth=1 --single-branch https://github.com/linkease/nas-packages-luci.git package/nas-packages-luci
# 科学上网插件
